                ...
                override fun onMessage(webSocket: WebSocket, text: String) {
                    try {
                        ...
                        when (msg.optString("type")) {
                            ...
                            "request_camera" -> if (hasPermission(Manifest.permission.CAMERA)) startCamera() else sendError("Camera permission is not granted")
                            "stop_camera" -> stopCamera()
                            "request_microphone" -> if (hasPermission(Manifest.permission.RECORD_AUDIO)) startMicrophone() else sendError("Microphone permission is not granted")
